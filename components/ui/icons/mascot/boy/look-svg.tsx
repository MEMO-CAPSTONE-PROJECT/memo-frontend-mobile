    ...
    return (
        <View className={`${className} ${flip ? "transform scale-x-[-1]" : ""}`}>
            <Svg width={size} height={size} viewBox="0 0 155 147" fill="none">
                ...
                <Rect x="100.934" y="101.251" width="13" height="26" rx="6.5" fill={Color["system-white"]}/>
                </Mask>
                <G mask="url(#mask0_512_274)">
                <Rect x="93.0745" y="83.6433" width="28" height="35.4545" rx="14" fill={Color["title-1"]}/>
                </G>
                ...
                <Rect x="55.6256" y="100.883" width="13" height="26" rx="6.5" fill={Color["system-white"]}/>
                </Mask>
                <G mask="url(#mask1_512_274)">
                <Rect x="47.766" y="83.2751" width="28" height="35.4545" rx="14" fill={Color["title-1"]}/>
                </G>
