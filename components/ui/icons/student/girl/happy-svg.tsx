...
interface StudentGirlHappySvgProps {
    size: number
    flip?: boolean
    className?: string
}

export default function StudentGirlHappySvg({ size, flip, className = "" }: Readonly<StudentGirlHappySvgProps>) {
    return (
        <View className={`${className} ${flip ? "transform scale-x-[-1]" : ""}`}>
            <Svg width={size} height={size} viewBox="0 0 122 147" fill="none">
                ...
                <Path d="M21.4656 106.418C18.0686 109.268 17.5113 105.385 14.6713 102C11.8312 98.6154 7.78403 97.0114 11.181 94.161C14.5779 91.3107 19.634 91.7438 22.474 95.1284C25.314 98.513 24.8625 103.567 21.4656 106.418Z" fill={Color["primary-2"]} />
                <Path d="M39.4352 91.0341C42.8321 88.1838 38.8399 86.8952 35.9999 83.5106C33.1599 80.126 32.5475 75.9271 29.1506 78.7774C25.7536 81.6278 25.3022 86.6822 28.1422 90.0668C30.9822 93.4514 36.0382 93.8845 39.4352 91.0341Z" fill={Color["primary-2"]} />
