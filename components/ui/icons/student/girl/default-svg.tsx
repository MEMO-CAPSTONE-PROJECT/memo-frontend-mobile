...
export default function StudentGirlDefaultSvg({ size, width, height, className = "", flip = false, container = "none", 
    skinColor = Color["secondary-4"], hairColor = Color["title-1"], ribbonPrimaryColor = Color["primary-2"], ribbonSecondaryColor = Color["primary-3"]
}: Readonly<StudentGirlDefaultSvgProps>) {
    return (
        <View className={`${ContainerSize[container]} ${className} ${flip ? "transform scale-x-[-1]" : ""}`}>
            <Svg width={width ?? size} height={height ?? size} viewBox="0 0 122 147" fill="none">
                <Rect y="29" width="122" height="118" rx="20" fill={hairColor} />
                <Rect x="10.0001" y="57" width="102" height="90" rx="30" fill={skinColor} />
                ...
                <Ellipse cx="10.4999" cy="87" rx="10.5" ry="20" fill={hairColor} />
                <Ellipse cx="77.9999" cy="79" rx="15" ry="20" fill={hairColor} />
                <Rect x="0.00012207" y="29" width="122" height="60" rx="20" fill={hairColor} />
                <Circle cx="102" cy="88" r="20" fill={hairColor} />
                <Ellipse cx="87" cy="60" rx="30" ry="27" fill={hairColor} />
                <Ellipse cx="43.544" cy="30.8434" rx="26" ry="8" transform="rotate(29.7383 43.544 30.8434)" fill={hairColor} />
                <Ellipse cx="60.588" cy="25.8837" rx="34.5942" ry="10.8019" transform="rotate(151.763 60.588 25.8837)" fill={hairColor} />
